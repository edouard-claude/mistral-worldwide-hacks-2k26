...
const t = {
  ...
  "swarm.spectrum": { fr: "★ SPECTRE POLITIQUE ★", en: "★ POLITICAL SPECTRUM ★" },
  "swarm.spectrumLeft": { fr: "GAUCHE", en: "LEFT" },
  "swarm.spectrumRight": { fr: "DROITE", en: "RIGHT" },
  "swarm.speaking": { fr: "◀ PARLE", en: "◀ SPEAKING" },
  "swarm.eliminatedLabel": { fr: "☠ ÉLIMINÉ", en: "☠ ELIMINATED" },
  "swarm.danger": { fr: "☠ EN DANGER", en: "☠ AT RISK" },
  "swarm.conviction": { fr: "CONV", en: "CONV" },
  "swarm.temperature": { fr: "TEMP", en: "TEMP" },
  "swarm.hallOfHeroes": { fr: "HALL DES HÉROS", en: "HALL OF HEROES" },

  // ── GmTerminal ──
  "terminal.waiting": { fr: "EN ATTENTE DES ORDRES...", en: "AWAITING ORDERS..." },
  "terminal.journal": { fr: "JOURNAL TECHNIQUE", en: "TECHNICAL LOG" },
  "terminal.thinking": { fr: "le général réfléchit...", en: "the general is thinking..." },
  "terminal.announcements": { fr: "COMMUNIQUÉS DE MISTRALSKI", en: "MISTRALSKI BULLETINS" },
  ...
  "gm.noStrategy": { fr: "Le camarade général n'a pas encore parlé.", en: "The comrade general has not spoken yet." },
  "gm.currentSituation": { fr: "SITUATION ACTUELLE", en: "CURRENT SITUATION" },
